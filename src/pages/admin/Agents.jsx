...
export default function Agents() {
  ...
  return (
    <div>
      <PageHeader title="Agents" description={`${agents.length} registered agents`} />
      <DataTable data={agents} columns={columns} searchFields={['full_name', 'email']} emptyTitle="No agents" />
    </div>
  );
}